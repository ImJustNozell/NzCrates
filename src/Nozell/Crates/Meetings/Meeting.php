...
final class Meeting
{
    ...
    public function join(): void
    {
        ...
        $this->CratesData->setKeyEnder(
            CratesUtils::getKeyBox($player, "ender")
        );
        $this->CratesData->setKeyMagma(
            CratesUtils::getKeyBox($player, "magma")
        );
        $this->CratesData->setKeyPegasus(
            CratesUtils::getKeyBox($player, "pegasus")
        );
    ...
    public function Close(bool $onClose = false): void
    {
        ...
        CratesUtils::setKeyBox(
            $player,
            "mage",
            $this->CratesData->getKeyMage()
        );
        CratesUtils::setKeyBox($player, "ice", $this->CratesData->getKeyIce());
        CratesUtils::setKeyBox(
            $player,
            "ender",
            $this->CratesData->getKeyEnder()
        );
        CratesUtils::setKeyBox(
            $player,
            "magma",
            $this->CratesData->getKeyMagma()
        );
        CratesUtils::setKeyBox(
            $player,
            "pegasus",
            $this->CratesData->getKeyPegasus()
        );
